...
public class User {
   ...
   // @Size(min = 6)
    ...
    private List<PortfoliosDetails> portfolios = new ArrayList<>();
    ...
    public List<PortfoliosDetails> getPortfolios() {
        return portfolios;
    }

    public void setPortfolios(List<PortfoliosDetails> portfolios) {
